    ...
    <section className="min-h-screen flex items-center relative overflow-hidden" id="hero">
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 to-blue-900">
              Discover Your
            </span>
            <br />
            <span className="text-shadow-lg/20 text-indigo-200">Future Self</span>
          </motion.h1>
      ...
      <div className="absolute -bottom-2 left-0 w-full overflow-hidden leading-none">
        <svg
          ...
          className="w-full h-20 text-indigo-200"
        >
          <path
